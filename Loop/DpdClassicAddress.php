 ...
 */
class DpdClassicAddress extends Address
{
    ...
    {
        $this->exists = DpdclassicAddressQuery::create()->findPK($id) !== null;
    }
    ...
    public function buildModelCriteria()
    {
        ...
        return $this->exists ? DpdclassicAddressQuery::create()->filterById($id[0]) : parent::buildModelCriteria();
    }
