...
use DpdClassic\Model\Thelia\Model\Area as ChildArea;
...
abstract class DpdclassicPrice implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\DpdClassic\\Model\\Map\\DpdclassicPriceTableMap';
    ...
    /**
     * Initializes internal state of DpdClassic\Model\Base\DpdclassicPrice object.
     */
     ...
     *
     * @return DpdclassicPrice The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DpdclassicPriceTableMap::ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DpdclassicPriceTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDpdclassicPriceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DpdclassicPrice::setDeleted()
     * @see DpdclassicPrice::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildDpdclassicPriceQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DpdclassicPriceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO dpdclassic_price (%s) VALUES (%s)',
    ...
    {
        $pos = DpdclassicPriceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['DpdclassicPrice'][$this->getPrimaryKey()] = true;
        $keys = DpdclassicPriceTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DpdclassicPriceTableMap::ID)) $criteria->add(DpdclassicPriceTableMap::ID, $this->id);
        if ($this->isColumnModified(DpdclassicPriceTableMap::AREA_ID)) $criteria->add(DpdclassicPriceTableMap::AREA_ID, $this->area_id);
        if ($this->isColumnModified(DpdclassicPriceTableMap::WEIGHT)) $criteria->add(DpdclassicPriceTableMap::WEIGHT, $this->weight);
        if ($this->isColumnModified(DpdclassicPriceTableMap::PRICE)) $criteria->add(DpdclassicPriceTableMap::PRICE, $this->price);
    ...
    {
        $criteria = new Criteria(DpdclassicPriceTableMap::DATABASE_NAME);
        $criteria->add(DpdclassicPriceTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DpdClassic\Model\DpdclassicPrice (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \DpdClassic\Model\DpdclassicPrice Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(DpdclassicPriceTableMap::DEFAULT_STRING_FORMAT);
    }
